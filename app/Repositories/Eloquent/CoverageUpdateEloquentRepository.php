...
class CoverageUpdateEloquentRepository extends EloquentRepository
{
    #[Pure]
    ...
    public function create(array $data): Coverage | Model
    {
    ...
    public function update($id, array $data): Coverage | Model
    {
